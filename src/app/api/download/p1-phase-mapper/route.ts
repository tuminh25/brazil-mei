// src/app/api/download/p1-phase-mapper/route.ts
...
export async function GET(request: Request) {
  ...
  const masterPath = path.join(
    ...
    "digital-products",
    "p1-phase-mapper",
    P1_PHASE_MAPPER_PRODUCT.masterAssetFile
  );
  ...
  return new Response(new Uint8Array(fileBuffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${P1_PHASE_MAPPER_PRODUCT.downloadFileName}"`,
