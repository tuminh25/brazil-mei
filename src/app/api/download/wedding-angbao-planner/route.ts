// src/app/api/download/wedding-angbao-planner/route.ts
...
export async function GET(request: Request) {
  ...
  const masterPath = path.join(
    ...
    WEDDING_ANGBAO_PRODUCT.masterAssetFile
  );
  ...
  return new Response(new Uint8Array(fileBuffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${WEDDING_ANGBAO_PRODUCT.downloadFileName}"`,
