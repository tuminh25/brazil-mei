// src/app/api/download/hdb-tenant-pack/route.ts
...
export async function GET(request: Request) {
  ...
  const masterPath = path.join(
    ...
    "digital-products",
    "hdb-tenant-pack",
    HDB_TENANT_PRODUCT.masterAssetFile
  );
  ...
  return new Response(new Uint8Array(fileBuffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${HDB_TENANT_PRODUCT.downloadFileName}"`,
