// src/app/api/download/home-bakery-calculator/route.ts
...
export async function GET(request: Request) {
  ...
  const masterPath = path.join(
    ...
    HOME_BAKERY_PRODUCT.masterAssetFile
  );
  ...
  return new Response(new Uint8Array(fileBuffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${HOME_BAKERY_PRODUCT.downloadFileName}"`,
