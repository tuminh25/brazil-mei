// src/app/api/download/pr-readiness-audit/route.ts
...
export async function GET(request: Request) {
  ...
  const masterPath = path.join(
    ...
    "digital-products",
    "pr-readiness-audit",
    PR_READINESS_PRODUCT.masterAssetFile
  );
  ...
  return new Response(new Uint8Array(fileBuffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${PR_READINESS_PRODUCT.downloadFileName}"`,
