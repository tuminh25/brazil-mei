// src/app/api/download/hdb-renosmart-planner/route.ts
...
export async function GET(request: Request) {
  ...
  const masterPath = path.join(
    ...
    HDB_RENOSMART_PRODUCT.masterAssetFile
  );
  ...
  return new Response(new Uint8Array(fileBuffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${HDB_RENOSMART_PRODUCT.downloadFileName}"`,
