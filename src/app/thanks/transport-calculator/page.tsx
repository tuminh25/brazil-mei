// src/app/thanks/transport-calculator/page.tsx
// Post-Purchase thank-you page for the Transport Cost Decision Calculator.
...
export const metadata: Metadata = {
  title: "Your Calculator Is Ready — SGEventsHub",
  robots: { index: false, follow: false },
};

export default function TransportCalculatorThanksPage() {
        ...
        <div className="card-elevated rounded-[var(--radius-3xl)] p-10 md:p-14">
          ...
          {configError ? (
            ...
            <div className="flex flex-col items-center gap-4 mb-8">
              <a href={`/api/download/transport-calculator?token=${encodeURIComponent(token!)}`} className="btn btn-primary btn-lg w-full sm:w-auto" download>
          ...
          <div className="rounded-2xl border border-[var(--color-border)] p-6 mb-8">
            ...
            <ul className="space-y-2 text-sm text-[var(--color-text-secondary)] leading-relaxed list-none pl-0">
              ...
              <li>• Start on the START HERE tab, then enter your numbers in the yellow cells on INPUTS.</li>
              <li>• COMPARISON shows your 1-year and 10-year totals; SCENARIO ANALYSIS stress-tests them.</li>
              <li>• All pre-filled figures are editable examples — replace them with your own.</li>
            </ul>
          </div>
