// src/app/thanks/home-bakery-calculator/page.tsx
// Post-Purchase thank-you page for the Home Bakery Pricing & Profit Calculator.
...
import { HOME_BAKERY_PRODUCT } from "@/config/products";
...
export const metadata: Metadata = {
  title: "Your Bakery Calculator Is Ready — SGEventsHub",
  robots: { index: false, follow: false },
};

export default function HomeBakeryCalculatorThanksPage() {
  const product = HOME_BAKERY_PRODUCT;
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="card-elevated rounded-[var(--radius-3xl)] p-10 md:p-14">
          <h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4 text-center">
            Your bakery calculator is ready.
          </h1>
          ...
          {configError ? (
            ...
            <div className="flex flex-col items-center gap-4 mb-8">
              <a href={`/api/download/home-bakery-calculator?token=${encodeURIComponent(token!)}`} className="btn btn-primary btn-lg w-full sm:w-auto" download>
                Download the Calculator ({product.priceLabel} · .xlsx)
              </a>
          ...
          <div className="rounded-2xl border border-[var(--color-border)] p-6 mb-8">
            ...
            <ul className="space-y-2 text-sm text-[var(--color-text-secondary)] leading-relaxed list-none pl-0">
              ...
              <li>• Start on the START HERE tab, then enter what you buy on INGREDIENTS — cost per unit calculates automatically.</li>
              <li>• Enter recipe quantities on RECIPE COSTING; line costs pull from your database.</li>
              <li>• Set your time value on LABOUR &amp; OVERHEAD, then review PRICING &amp; PROFIT for margins and monthly projections.</li>
              <li>• Before renting a shared kitchen, run UPGRADE SCENARIO to see what price or volume it really needs.</li>
            </ul>
          </div>
