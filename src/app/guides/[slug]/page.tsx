        ...
        <div className="lg:col-span-8">
          ...
          <div className="mt-32 p-12 md:p-20 bg-gradient-to-br from-blue-600 to-indigo-900 rounded-[4rem] text-center shadow-2xl relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
                <a href={`https://www.trip.com/?allianceid=7367361&sid=278066643`} target="_blank" className="bg-white text-black px-10 py-5 rounded-2xl font-black text-lg hover:scale-105 transition-all shadow-xl">HOTELS ON TRIP.COM</a>
                <a href={`https://www.klook.com/en-SG/?aid=105111`} target="_blank" className="bg-[#ff5b00] text-white px-10 py-5 rounded-2xl font-black text-lg hover:scale-105 transition-all shadow-xl">ACTIVITIES ON KLOOK</a>
              </div>
          </div>
        </div>
